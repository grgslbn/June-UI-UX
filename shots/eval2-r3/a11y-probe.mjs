...
await q.screenshot({ path: 'shots/eval2-r3/task-advice-added.png' });
...
await q.screenshot({ path:'shots/eval2-r3/peak-disclosure-open.png', fullPage:true });
...
writeFileSync('shots/eval2-r3/a11y.json', JSON.stringify(res,null,1));
await b.close();
