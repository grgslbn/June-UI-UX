...
export const copy = {
  'nl-be': {
    ...
    faq: { eyebrow: 'FAQ', title: 'Veelgestelde vragen', ids: ['not-a-supplier', 'cost', 'no-interruption', 'approval', 'exit-fee'] },
    final: {
  ...
  'fr-be': {
    ...
    faq: { eyebrow: 'FAQ', title: 'Questions fréquentes', ids: ['not-a-supplier', 'cost', 'no-interruption', 'approval', 'exit-fee'] },
    final: {
